...
import fran.service.OrdenesService;
...
/**
 * REST controller for managing {@link fran.domain.Ordenes}.
 */
@RestController
@RequestMapping("/api")
public class OrdenesResource {
     ...
     */
    @GetMapping("/ordenes")
    public ResponseEntity<List<OrdenesDTO>> getAllOrdenes(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Ordenes");
        Page<OrdenesDTO> page = ordenesService.findAll(pageable);
