...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fran.um.edu.ar.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fran.um.edu.ar.repository.UserRepository.USERS_BY_EMAIL_CACHE);
