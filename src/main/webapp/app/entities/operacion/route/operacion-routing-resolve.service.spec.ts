...
describe('Operacion routing resolve service', () => {
  ...
  let resultOperacion: IOperacion | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOperacion).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOperacion>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
